  ...
  return (
    ...
    >
      ...
      >
        ...
        <ScrambleText>Ahmad Sunhadi Kamil</ScrambleText>
        ...
        <p className="max-w-lg text-center text-sm dark:text-white md:max-w-2xl md:text-left md:text-base leading-relaxed">
          Seorang <b>Fullstack Developer</b> yang berdedikasi dengan penguasaan berbagai bahasa pemrograman. 
          Memiliki rekam jejak yang kuat dalam mengelola siklus hidup pengembangan 
          <b> Aplikasi Mobile serta Web</b> secara <i>end-to-end</i>.
        </p>
